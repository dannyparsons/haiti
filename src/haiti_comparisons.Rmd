...
for (i in seq_along(stations)) {
  s <- stations[i]
  monthly_plots(gof_pr_month %>% filter(station == s), #provides all the data in bold above the plot
                stat_pr = "total_rain__chirps_rain",
                stat_st = "total_rain__station", product_name = "CHIRPS") #product_name = a is a dummy variable at the momment

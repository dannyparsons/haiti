...
write.csv(here("results", "zero_months.csv"))
zm_month <- zm %>%
...
for (i in seq_along(stations)) {
  s <- stations[i]
  g <- monthly_plots(gof_pr_month %>% filter(station == s),
                     stat_pr = "total_rain__chirps_rain", gof_col = "gof__total_rain",
                     stat_st = "total_rain__station", product_name = "CHIRPS")
  print(g)
  ggsave(here("results", paste0("month_total_rain_", s, ".png")), g, width = 12, height = 6)
}
```
...
=======
>>>>>>> 327f028b547ed808ec183848272a1bf9084f3e7b
